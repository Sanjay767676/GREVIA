  ...
  return (
    <div className="space-y-6">
      <section>
        ...
        <ComplaintTable complaints={escalated} basePath="/hod/complaints" emptyLabel="No escalated complaints." />
      </section>
      <section>
        <h2 className="mb-3 text-sm font-semibold text-red-600">SLA violations</h2>
        <ComplaintTable complaints={violations} basePath="/hod/complaints" emptyLabel="No SLA violations." />
      </section>
    </div>
  );
}
